        ...
        <?php }else{ ?>
            <div class="d-flex justify-content-center" style="opacity: 75%; min-height: 80vh;align-items: center;">
                <div style="max-width: 450px;">
                        <i class="fas fa-trash-can" style="font-size: 1000%;"></i>
                </div>
                <div style="max-width: 450px;">
            ...
            <div class="col-12 modal-content">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12  mt-3">
                        <div class="row">
                            <div class="col-6">
                                <form action="/trash/delete" method="POST">
                                    <input type="text" id="IDnoteDelete" name="id" hidden>
                            ...
                            <div class="col-6 d-flex justify-content-end">
                                <form action="/trash/restore" method="POST">
                                    <input type="text" id="IDnoteRestore" name="id" hidden>
